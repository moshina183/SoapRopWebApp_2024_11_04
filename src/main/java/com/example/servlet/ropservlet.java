...
public class ropservlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String xml = (String) request.getAttribute("xmlData");
	    System.out.println("Received XML in doGet: " + xml);
		String infoBinder = "";
		String wsdlOpname = "";
		String wsdlRequest = "";
		String projectFile = "";
		...
		if ("/personInfo".equals(path)) {
            ...
            //Dev
        	//projectFile = "C:/Users/prasanth.s/Moshina/ROP-xml-2024-10-30/ROP-prod services/ROP-PROD-soapui-project.xml";
        	//UAT
